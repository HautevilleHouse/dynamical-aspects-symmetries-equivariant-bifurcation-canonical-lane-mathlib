import DynamicalAspectsSymmetriesEquivariantBifurcationCanonicalLaneLean.ReviewerBridge

/-!
# Theorem Statement Layer

This module internalizes the theorem-facing object for `dynamical-aspects-symmetries-equivariant-bifurcation-canonical-lane`
